...
| prototype-driven-task-decomposition | ✅ Built; D01 landed 2026-05-04 (roadmap consumption — schema gains 3 task fields + 2 top-level fields + 4 validators; consumes roadmap.json + components.json as primary input) | D01 (2026-05-04) |
...
| prototype-driven-implementation | ✅ Built; T14-refactor landed 2026-04-19 (TASK_TEST_COMMANDS verbatim from schema; scaffold runs test_command); compose_prompt.py.template gained `_inline_roadmap_scenarios` 2026-05-03 (validates end-to-end via T15) | T14 (2026-04-19) |
