...
- `test-authoring` — Planning model test quality (embedding divergence, missing guidance)
...
| T31 | Qwen | 8✅ 9⚠️ 1❌ | `task-doc-gap`, `sqlite-trap`, `schema-trap` | UUIDStore, GDrive, Calories, Avro, DAG | Clean branch; `:memory:` caught; 9 task doc gaps; first Avro redefined type | Pending |
